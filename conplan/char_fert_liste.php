...
function get_menu_char_fert($md, $PHP_SELF, $ID, $titel, $id, $daten, $sub, $home)
{
  switch ($md):
  case char_add: // Erfassen eines neuen Datensatzes
    $menu = array (0=>array("icon" => "99","caption" => "FERTIGKEITEN","link" => ""),
...
// ----------------------------------------------------------------
  ...
  $titel = "Charakterdaten";
	...
	$menu = get_menu_char_fert($md, $PHP_SELF, $ID, $titel, $id, $daten, $sub, $home);

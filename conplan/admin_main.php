...
default:
	...
	2=>array ("icon" => "_data","caption" => "News","link" => "admin_news.php?md=0&ID=$ID"),
	3=>array ("icon" => "_data","caption" => "Anmeldung","link" => "admin_anmelde.php?md=0&ID=$ID"),
	4=>array ("icon" => "_data","caption" => "Hilfe","link" => "admin_hilfe.php?md=0&ID=$ID"),
	5=>array ("icon" => "_data","caption" => "CON-SL","link" => "admin_con.php?md=0&ID=$ID"),
	6=>array ("icon" => "_data","caption" => "Bilder","link" => "admin_bilder.php?md=0&ID=$ID"),
	...
	16=>array ("icon" => "_folder_n","caption" => "<b>Configuration</b>","link" => "admin_config.php?md=0&ID=$ID"),

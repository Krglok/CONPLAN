...
function get_menu_mfd_editor($md,$PHP_SELF, $ID,$titel,$id,$daten,$sub,$home)
{
  ...
  default:  // MAIN-Menu
    ...
    2=>array("icon" => "_list","caption" => "Übersicht","link" => "$PHP_SELF?md=0&ID=$ID&sub="),
    //    	3=>array("icon" => "5","caption" => "Drucken","link" => "con_mag_rep.php?md=0&ID=$ID&sub=$sub"),
    9=>array("icon" => "0","caption" => "","link" => ""),
    10=>array("icon" => "_list","caption" => "Neutrale Magie","link" => "$PHP_SELF?md=9&ID=$ID&sub=NT"),
    11=>array("icon" => "_list","caption" => "Runenmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=RU"),
    12=>array("icon" => "_list","caption" => "Elementar Magie","link" => "$PHP_SELF?md=9&ID=$ID&sub=EL"),
    13=>array("icon" => "_list","caption" => "Rituale","link" => "$PHP_SELF?md=9&ID=$ID&sub=RI"),
    14=>array("icon" => "_list","caption" => "Koboldmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=KO"),
    15=>array("icon" => "_list","caption" => "Bardenmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=BA"),
    20=>array("icon" => "0","caption" => "","link" => ""),
    22=>array("icon" => "_list","caption" => "Weisse Magie","link" => "$PHP_SELF?md=9&ID=$ID&sub=WM"),
    24=>array("icon" => "_list","caption" => "Heilmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=HM"),
    25=>array("icon" => "_list","caption" => "Drachenmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=DR"),
    26=>array("icon" => "_list","caption" => "Priestermagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=PR"),
    30=>array("icon" => "0","caption" => "","link" => ""),
    32=>array("icon" => "_list","caption" => "Schwarze Magie","link" => "$PHP_SELF?md=9&ID=$ID&sub=SM"),
    34=>array("icon" => "_list","caption" => "Nekromantie","link" => "$PHP_SELF?md=9&ID=$ID&sub=NE"),
    36=>array("icon" => "_list","caption" => "Daemonologie","link" => "$PHP_SELF?md=9&ID=$ID&sub=DM"),
    37=>array("icon" => "_list","caption" => "Daemonenmagie","link" => "$PHP_SELF?md=9&ID=$ID&sub=DA"),

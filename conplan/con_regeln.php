...
function print_maske($id,$ID,$next,$erf, $KAP)
{
	...
	echo "<FORM ACTION=\"$PHP_SELF?md=0&ID=$ID&KAP=$KAP\" METHOD=POST>\n";
...
//  2=>array("icon" => "1","caption" => "KAP 1","link" => "$PHP_SELF?md=11&ID=$ID"),
{
	...
	$menu = array (0=>array("icon" => "99","caption" => "REGELWERK","link" => ""),
			1=>array("icon" => "0","caption" => "Erfassen","link" => "$PHP_SELF?md=1&KAP=$KAP&ID=$ID"),
			2=>array("icon" => "0","caption" => "KAPITEL","link" => "$PHP_SELF?md=0&THEMEN=$KAP&ID=$ID"),
	);
	...
	$menu[50] = array("icon" => "_stop","caption" => "Zurück","link" => "con_main.php?md=0&ID=$ID");

	return  $menu;

};

function get_menu_regeln($md,$PHP_SELF, $ID,$titel,$id,$daten,$sub,$home)
{
  switch ($md):
  case 1: // Erfassen eines neuen Datensatzes
    $menu = array (0=>array("icon" => "1","caption" => "ERFASSEN","link" => ""),
    				2=>array("icon" => "_stop","caption" => "Zurück","link" => "$PHP_SELF?md=0&ID=$ID&KAP=$sub")
    );
    break;
  case 2: // Ansehen / INFO eines Datensatzes
    $menu = array (0=>array("icon" => "1","caption" => "ANSEHEN","link" => ""),
    8=>array("icon" => "_stop","caption" => "Zurück","link" => "$PHP_SELF?md=0&ID=$ID&KAP=$sub")
    );
    break;
  case 3: // Delete eines bestehenden Datensatzes
    $menu = array (0=>array("icon" => "1","caption" => "LÖSCHEN","link" => ""),
    9=>array("icon" => "_stop","caption" => "Zurück","link" => "$PHP_SELF?md=0&ID=$ID&KAP=$sub")
    );
    break;
...
// ----------------------------------------------------------------
  ...
  $menu = get_menu_regeln($md,$PHP_SELF, $ID,$titel,$id,$daten,$KAP,$home);

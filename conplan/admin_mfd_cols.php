...
function mfd_list_info_link($ID,$id)
{
  ...
  $link = $PHP_SELF."?md=".mfd_info."&id=$id&daten=$daten&back=$PHP_SELF&ID=$ID";
  return $link;
}
...
case mfd_info: // 
  ...
  $menu = array (0=>array("icon" => "7","caption" => "MFD-COLS","link" => ""),
  1=>array("icon" => "1","caption" =>$ref_mfd, "link" => ""),
  2=>array ("icon" => "_tinfo","caption" => "View","link" => "admin_mfd_view.php?md=0&amp;daten=$daten&amp;back=$PHP_SELF&amp;ID=$ID"),
  5=>array ("icon" => "_stop","caption" => "Zurück","link" => "admin_mfd.php?md=0&amp;ID=$ID")
  );
  break;
  endswitch;

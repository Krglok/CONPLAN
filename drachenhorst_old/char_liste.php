...
//  print_header("Charakterliste");  // nur fuer Fehle test
...
case 0:  // MAIN-Menu
		$menu = array (0=>array("icon" => "99","caption" => "CHARAKTER","link" => ""),
				...
				3=>array("icon" => "5","caption" => "CON-Tage","link" => "char_tage_liste.php?md=0&ID=$ID"),
				4=>array("icon" => "5","caption" => "Aktivieren","link" => "$PHP_SELF?md=8&ID=$ID"),
...
case 8: // Aktivieren des aktuellen Char
	$menu = array (0=>array("icon" => "99","caption" => "CHARAKTER","link" => ""),
	1=>array("icon" => "99","caption" => "AKTIVIEREN","link" => ""),
	2=>array("icon" => "6","caption" => "Zurück","link" => "$PHP_SELF?md=0&ID=$ID&TAG=$TAG")
	);
	print_menu($menu);
	print_aktiv($ID);

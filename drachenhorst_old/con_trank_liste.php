...
$Log: mag_liste.php,v $
Revision 1.3  2008/02/18    windu
Ableitung Trank_list von mag_list
Die Traenke werden ebenfalls wie die Magieliste in Gruppen verwaltet
daher eignet sich die Mag_List.-php gut ls Vorlage fuer die Trank-Liste
...
function print_liste($ID, $grp)
{
	...
	$q = "select id, grp,nr,stufe,name,herstellung from $TABLE where grp=\"$grp\" order by grp DESC, stufe";
...
//  2=>array("icon" => "1","caption" => "Tag 1","link" => "$PHP_SELF?md=11&ID=$ID"),
{
	...
	$menu = array (0=>array("icon" => "7","caption" => "ALCHIMIE","link" => ""),
			1=>array("icon" => "","caption" => "","link" => ""),
			2=>array("icon" => "3","caption" => "Erfassen","link" => "$PHP_SELF?md=1&ID=$ID&grp=$grp"),
			3=>array("icon" => "10","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID&grp=$grp"),
			4=>array("icon" => "12","caption" => "Drucken","link" => "mag_rep.php?md=0&ID=$ID&grp=$grp"),
			5=>array("icon" => "1","caption" => "Übersicht","link" => "$PHP_SELF?md=0&grp=%"),
			8=>array("icon" => "0","caption" => "BEREICHE","link" => "$PHP_SELF?md=0&grp=%"),
	);
	// der zaehler wird erhoeht, damit er direkt fuer die array indeces verwendet werden kann
	for ($i=0; $i<$anz; $i++)
	{
		$row = mysql_fetch_row($result);
		$menu[$i+10] = array("icon" => "1","caption" => "$i.$row[2]","link" => "$PHP_SELF?md=0&grp=$row[1]");
	}
...
case 1: // Erfassen eines neuen Datensatzes
		$menu = array (0=>array("icon" => "99","caption" => "TRÄNKE","link" => ""),
...
default:  // MAIN-Menu
	...
	3=>array("icon" => "5","caption" => "Drucken","link" => "con_trank_rep.php?md=0&ID=$ID&grp=$grp"),
	8=>array("icon" => "","caption" => "","link" => ""),
	9=>array("icon" => "5","caption" => "Übersicht","link" => "$PHP_SELF?md=0&ID=$ID"),
	10=>array("icon" => "5","caption" => "Trank","link" => "$PHP_SELF?md=9&ID=$ID&grp=TRANK"),
	11=>array("icon" => "5","caption" => "Gift","link" => "$PHP_SELF?md=9&ID=$ID&grp=GIFT"),
	12=>array("icon" => "5","caption" => "Heiltrank","link" => "$PHP_SELF?md=9&ID=$ID&grp=HEIL"),

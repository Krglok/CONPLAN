...
beschreibung : realisiert die Bearbeitungsfunktionen für die Artefakte
...
function print_liste($ID)
{
	...
	$q = "select id,s0,name,kurz,ismagisch,wert from $TABLE order by s0,name ";
...
default :
	...
	print_kopf(1,9,"Artefakte","Sei gegrüsst Meister ");
...
case 4: // Anzigen Bearbeiten Form
	...
	break;
default:  // MAIN-Menu
	$menu = array (0=>array("icon" => "99","caption" => "ARTEFAKTE","link" => ""),

		...
		for ($i=0; $i<$field_num-1; $i++)
		{
			...
			if ($i==0)
			{
				if ($user_id == $row[11])
				{
					...
					print_menu_icon (4, "Datensatz löschen, unwiederruflich");
					echo "\t</a></td>\n";
				} else
				{
					echo "\t<td></td>\n";
...
function print_anmeld($id,$user,$next,$erf)
{
	...
	if ($err != 0)
	{
		...
		echo "  <TABLE WIDTH=\"435\" BORDER=\"0\" BGCOLOR=\"\" BORDERCOLOR=\"#C0C0C0\" BORDERCOLORDARK=\"#808080\" BORDERCOLORLIGHT=\"#C0C0C0\">\n";
		echo "    <TR HEIGHT=30>\n";
		echo "    <TD > <CENTER><B>ANMELDUNGSCHLUSS !&nbsp;$row1[6]&nbsp;&nbsp;&nbsp;</TD>\n";
		echo "    </TR>\n";
		echo "  </TABLE>\n";
		echo "  </TD\n>";  //Daten bereich der Gesamttabelle
	}  else
	{
		...
		echo "<TABLE WIDTH=\"590\" BORDER=\"1\" BGCOLOR=\"\" BORDERCOLOR=\"#C0C0C0\" BORDERCOLORDARK=\"#808080\" BORDERCOLORLIGHT=\"#C0C0C0\">\n";
		echo "<TR>\n";
		echo "<TD>\n";
		echo "    <TABLE WIDTH=\"500\" BORDER=\"0\" BGCOLOR=\"\" BORDERCOLOR=\"#C0C0C0\" BORDERCOLORDARK=\"#808080\" BORDERCOLORLIGHT=\"#C0C0C0\">\n";
		echo "    <TR HEIGHT=10>\n";
		echo "    <TD></TD>\n";
		echo "    </TR>\n";
		echo "    <TR>\n";
		...
		echo "        <td><TEXTAREA NAME=\"row[10]\" COLS=50 ROWS=3>$row[10]</TEXTAREA>&nbsp;</td>\n";
		echo "        </TD>\n";
		echo "    </TR>\n";
		echo "    <TR>\n";
		echo "        <TD><!-- Row:5, Col:1 -->\n";
...
case 10:  // Meine Anmelde Liste
	...
	2=>array("icon" => "5","caption" => "Dienste","link" => "larp_anmelde_dienste.php?md=0&ID=$ID&TAG=$TAG"),
	3=>array("icon" => "5","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID&TAG=$TAG"),
	5=>array("icon" => "5","caption" => "Aktuelle Anmeldungen","link" => "$PHP_SELF?md=0&ID=$ID&TAG=$TAG"),
	98=>array ("icon" => "5","caption" => "Reports ","link" => "larp_anmelde_rep.php?md=0&ID=$ID"),
	9=>array("icon" => "6","caption" => "Zurück","link" => "larp.php?md=0&ID=$ID&TAG=$TAG")
	);
	break;
...
default:  // MAIN-Menu
	...
	2=>array("icon" => "5","caption" => "Dienste","link" => "larp_anmelde_dienste.php?md=0&ID=$ID&TAG=$TAG"),
	3=>array("icon" => "5","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID&TAG=$TAG"),
	5=>array("icon" => "5","caption" => "alle Anmeldungen","link" => "$PHP_SELF?md=10&ID=$ID&TAG=$TAG"),
	6=>array("icon" => "5","caption" => "Con Liste","link" => "$PHP_SELF?md=11&ID=$ID&TAG=$TAG"),
	98=>array ("icon" => "5","caption" => "Reports ","link" => "larp_anmelde_rep.php?md=0&ID=$ID"),
	9=>array("icon" => "6","caption" => "Zurück","link" => "larp.php?md=0&ID=$ID&TAG=$TAG")
	);
	endswitch;

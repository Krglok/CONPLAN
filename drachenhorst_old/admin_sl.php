...
case 10:  // MAIN-Menu
	...
	1=>array("icon" => "11","caption" => "Erfassen","link" => "$PHP_SELF?md=9&ID=$ID"),
	2=>array("icon" => "4","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID"),
	3=>array("icon" => "2","caption" => "CON-Tag setzen","link" => "$PHP_SELF?md=8&ID=$ID&id=1"),
	4=>array("icon" => "5","caption" => "CON-Zugriff","link" => "$PHP_SELF?md=0&ID=$ID&id=1"),
...
default:  // MAIN-Menu
	...
	2=>array("icon" => "4","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID"),
	3=>array("icon" => "2","caption" => "CON-Tag setzen ","link" => "$PHP_SELF?md=8&ID=$ID&id=1"),
	4=>array("icon" => "5","caption" => "CON-Liste","link" => "$PHP_SELF?md=10&ID=$ID&id=1"),
	9=>array("icon" => "6","caption" => "Zurück","link" => "admin_con.php?md=0&ID=$ID")
	);
	break;
	endswitch;

	...
	while ($row = mysql_fetch_row($result))
	{
		...
		for ($i=0; $i<$field_num; $i++)
		{
			...
			if ($i==0)
			{
				...
				//echo "\t<IMG SRC=\"../images/txt.gif\" BORDER=\"0\" HEIGHT=\"25\" WIDTH=\"25\" ALT=\"Datensatz Bearbeiten\" HSPACE=\"0\" VSPACE=\"0\" ALIGN=ABSMIDDLE>\n";
				print_menu_icon (7);
				echo "\t</a></td>\n";
			} else
			{
...
print_kopf(1,4,"Gilde des Wissens","Sei gegrüsst Suchender ");

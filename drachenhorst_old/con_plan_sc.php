...
function print_ID($ID)
{
	...
	while ($row = mysql_fetch_row($result))
	{
		...
		for ($i=0; $i<$field_num; $i++)
		{
			...
			if ($i==0)
			{
				echo "\t<td><a href=\"$PHP_SELF?md=1&ID=$ID&ID_id=$row[0]&TAG=$TAG\">\n";
				//        echo "\t<IMG SRC=\"../larp/images/db.gif\" BORDER=\"0\" HEIGHT=\"25\" WIDTH=\"25\" ALT=\"Spieler auswählen\" HSPACE=\"0\" VSPACE=\"0\" ALIGN=ABSMIDDLE>\n";
				print_menu_icon (9);
				echo "\t</a></td>\n";
			} else
			{
...
default :
	...
	print_kopf(9,0,"Con Planung NSC","Sei gegrüsst Meister ");
...
case 1: // Erfassen eines neuen Datensatzes
		$menu = array (0=>array("icon" => "99","caption" => "SC Tag $TAG","link" => ""),
...
case 8: // Delete eines bestehenden Datensatzes
	$menu = array (0=>array("icon" => "99","caption" => "SC Tag $TAG","link" => ""),
	1=>array("icon" => "99","caption" => "USER","link" => ""),
	9=>array("icon" => "6","caption" => "Zurück","link" => "$PHP_SELF?md=0&ID=$ID&TAG=$TAG")
	);
	break;
...
default:  // MAIN-Menu
	$menu = array (0=>array("icon" => "99","caption" => "SC Tag $TAG","link" => ""),
	1=>array("icon" => "11","caption" => "Erfassen","link" => "$PHP_SELF?md=8&ID=$ID&TAG=$TAG"),
	2=>array("icon" => "4","caption" => "Löschen","link" => "$PHP_SELF?md=3&ID=$ID&TAG=$TAG"),
	3=>array("icon" => "5","caption" => "Report","link" => "sc_rep.php?md=0&ID=$ID&TAG=$TAG"),

...
//==========================================================================
{
	...
	$where = "where bereich=\"$BIB\" AND thema like \"$THEMEN\" AND zugriff <>\"protect\"";
...
//  2=>array("icon" => "1","caption" => "Tag 1","link" => "$PHP_SELF?md=11&ID=$ID"),
{
	...
	$menu = array (0=>array("icon" => "99","caption" => "SL-BIBLIOTHEK","link" => ""),
	...
	$menu[50] = array("icon" => "6","caption" => "Zurück","link" => "conmain.php?md=0&ID=$ID&BIB=$BIB");
...
case 5:  // MAIN-Menu
	insert($p_row);
header ("Location: $PHP_SELF?md=9&ID=$ID&THEMEN=$THEMEN&BIB=$BIB");  /* Umleitung des Browsers
zur PHP-Web-Seite. */
exit;  /* Sicher stellen, das nicht trotz Umleitung nachfolgender
Code ausgeführt wird. */
break;
